...
from highway_env.vehicle.behavior import HazardousVehicle, IDMVehicle, LinearVehicle, FrozenModelVehicle
...
class VehicleGraphics(object):
    ...
    def get_color(cls, vehicle: Vehicle, transparent: bool = False) -> Tuple[int]:
        ...
        if getattr(vehicle, "color", None):
            ...
            color = cls.RED
        elif isinstance(vehicle, FrozenModelVehicle):
            color = cls.EGO_COLOR
        elif isinstance(vehicle, HazardousVehicle):
            color = cls.YELLOW
