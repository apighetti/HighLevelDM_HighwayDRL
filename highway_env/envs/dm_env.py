    ...
    def _create_vehicles(self, vehicle_distribution) -> None:
        ...
        for others in other_per_controlled:
            ...
            for i in range(others):
                ...
                vehicle = other_vehicles_type.create_random(self.road, speed = 15,\
                    lane_id = 1, spacing=10 / self.config["vehicles_density"]) #edit NPC // speed = self.get_npc_speed(aux,range(0,self.config['lanes_count'])
